...
import type { CircuitOutline, HudSnapshot, RaceMessage } from "@/race/application/race-ui-state";
...
export function Hud({ hud, startLights, message, outline, subscribeTelemetry }: Props) {
  return (
